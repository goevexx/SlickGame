...
public class Settings extends BasicGameState {
	...
	public Settings(int state) {
		...
		if (!loadFromFile()) {
			this.gameColor = standardGameColor;
			this.enemyColor = standardEnemyColor;
			this.shotColor = standardShotColor;
			words = new ArrayList<String>(Arrays.asList(standardWords));
			saveToFile();
		}
	}
